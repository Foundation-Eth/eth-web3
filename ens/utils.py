...
if TYPE_CHECKING:
    from eth_web3 import Web3 as _Web3  # noqa: F401
    from eth_web3.providers import (  # noqa: F401
        AsyncBaseProvider,
        BaseProvider,
    )
...
def Web3() -> Type["_Web3"]:
    from eth_web3 import Web3 as Web3Main
...
def init_web3(
    ...
    from eth_web3 import Web3 as Web3Main
    from eth_web3.eth import Eth as EthMain
...
def customize_web3(w3: "_Web3") -> "_Web3":
    from eth_web3.middleware import make_stalecheck_middleware
...
# borrowed from similar method at `eth_web3._utils.abi` due to circular dependency
...
def init_async_web3(
    ...
    from eth_web3 import Web3 as Web3Main
    from eth_web3.eth import AsyncEth as AsyncEthMain
...
async def _async_ens_stalecheck_middleware(
    ...
    from eth_web3.middleware import async_make_stalecheck_middleware
