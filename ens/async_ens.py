...
if TYPE_CHECKING:
    ...
    from eth_web3.contract import (  # noqa: F401
        AsyncContract,
    )
...
class AsyncENS(BaseENS):
    ...
    def __init__(
        ...
        :type provider: instance of `eth_web3.providers.base.BaseProvider`
    ...
    def fromWeb3(cls, w3: "Web3", addr: ChecksumAddress = None) -> "AsyncENS":
        """
        Generate an AsyncENS instance with eth_web3
    ...
    async def setup_address(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~eth_web3.eth.Eth.send_transaction`
        :raises InvalidName: if ``name`` has invalid syntax
    ...
    async def setup_name(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~eth_web3.eth.send_transaction`
