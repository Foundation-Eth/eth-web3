...
exclude_patterns = [
    ...
    "modules.rst",
    "eth_web3.auto.rst",
    "eth_web3.auto.infura.rst",
    "eth_web3.gas_strategies.rst",
    "eth_web3.middleware.rst",
    "eth_web3.providers.rst",
    "eth_web3.providers.eth_tester.rst",
    "eth_web3.scripts.*",
    "eth_web3.testing.rst",
    "eth_web3.tools.*",
]
...
man_pages = [("index", "eth_web3", "Web3.py Documentation", ["Piper Merriam"], 1)]
...
intersphinx_mapping = {
    ...
    "account-eth": ("http://account-eth.readthedocs.io/en/latest/", None),
