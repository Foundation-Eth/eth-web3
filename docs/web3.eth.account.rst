...
:class:`account_eth.Account <account_eth.account.Account>`.
...
.. code-block:: python
    ...
    import os 
    from account_eth import Account
    from account_eth.signers.local import LocalAccount
...
.. doctest::
    ...
    >>> from eth_web3.auto import w3
            >>> from account_eth.messages import encode_defunct
...
.. doctest::
    ...
    >>> from eth_web3 import Web3
            >>> from account_eth.messages import encode_defunct, _hash_eip191_message
...
#. Sign the transaction, with :meth:`w3.eth.account.sign_transaction()
   <account_eth.account.Account.sign_transaction>`
