...
- Update eth-tester dependency to v0.7.0-beta.1; Update account-eth version to
...
- Update dependency requirements: - utils-eth - eth-abi - eth-tester -
  account-eth - eth-typing (`#2342
...
- Update eth-tester and account-eth dependencies to pull in bugfix from
...
- Updated account-eth version to v0.5.6 - adds support for signing typed
...
- Upgrade account-eth to use v0.5.2+. account-eth 0.5.2 adds support for hd accounts
...
- Update utils-eth dependency which contains mypy bugfix. (`#1537 <https://github.com/ethereum/web3.py/issues/1537>`__)
...
- Misc
  ...
  - Replace ``web3._utils.toolz`` imports with ``utils_eth.toolz``
...
- Misc
  ...
  - Require utils-eth >= 1.4, downgrade Go version for integration tests
...
- Misc
  ...
  - Update utils-eth dependencies and clean up other dependencies
...
- Misc
  ...
  - Upgrade eth-tester and utils-eth
...
- Pinned account-eth to older version
...
- Upgrade most dependencies to stable
  ...
  - utils-eth
  - hexbytes
  - *not included: eth-tester and account-eth*
...
- utils-eth v1.0.1 (stable) compatibility
...
- bugfix: Compatibility with utils-eth v1-beta2
...
- `Bugfix <https://github.com/ethereum/web3.py/pull/616>`_
  dependency conflicts between utils-eth, eth-abi, and eth-tester
...
- replace internal implementation of w3.eth.account with
  :class:`account_eth.account.Account`
