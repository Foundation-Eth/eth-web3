...
from eth_web3._utils.abi import (
    abi_to_signature,
...
from eth_web3._utils.async_transactions import (
    fill_transaction_defaults as async_fill_transaction_defaults,
)
from eth_web3._utils.blocks import (
    is_hex_encoded_block_hash,
)
from eth_web3._utils.contracts import (
    encode_abi,
...
from eth_web3._utils.datatypes import (
    PropertyCheckingFactory,
)
from eth_web3._utils.empty import (
    empty,
)
from eth_web3._utils.encoding import (
    to_4byte_hex,
    to_hex,
)
from eth_web3._utils.events import (
    EventFilterBuilder,
    get_event_data,
    is_dynamic_sized_type,
)
from eth_web3._utils.filters import (
    LogFilter,
    construct_event_filter_params,
)
from eth_web3._utils.function_identifiers import (
    FallbackFn,
    ReceiveFn,
)
from eth_web3._utils.normalizers import (
...
from eth_web3._utils.transactions import (
...
from eth_web3.types import (  # noqa: F401
    ABI,
    ABIEvent,
    ABIFunction,
    BlockIdentifier,
...
class BaseContractEvents:
    ...
    .. code-block:: python
        ...
        >>> mycontract.events
        <eth_web3.contract.ContractEvents object at 0x108afde10>
    ...
    .. code-block:: python
        ...
        <class 'eth_web3._utils.datatypes.LogAnonymous'>
        ...
...
class BaseContract:
    ...
    :meth:`eth_web3.eth.Eth.contract` that takes compiled Solidity contract
    ...
    def __init__(self, address: Optional[ChecksumAddress] = None) -> None:
        ...
        if _w3 is None:
            raise AttributeError(
                ...
                "`eth_web3.contract` interface to create your contract class."
            )
...
class ContractFunction(BaseContractFunction):
    ...
    def call(
        ...
        :param transaction: Dictionary of transaction info for eth_web3 interface
...
class ContractEvent(BaseContractEvent):
    ...
    def getLogs(
        ...
        .. code-block:: python
            ...
            from = max(mycontract.eth_web3.eth.block_number - 10, 1)
            to = mycontract.eth_web3.eth.block_number
        ...
        See also: :func:`eth_web3.middleware.filter.local_filter_middleware`.
