...
from eth_web3._utils.module import (
    attach_modules as _attach_modules,
)
from eth_web3._utils.normalizers import (
    abi_ens_resolver,
)
from eth_web3.eth import (
    Eth,
)
from eth_web3.geth import (
    Geth,
    GethAdmin,
    GethMiner,
    GethPersonal,
...
from eth_web3.manager import (
    RequestManager as DefaultRequestManager,
)
from eth_web3.module import (
    Module,
)
from eth_web3.net import (
    AsyncNet,
    Net,
)
from eth_web3.parity import (
    Parity,
    ParityPersonal,
)
...
from eth_web3.providers.rpc import (
    HTTPProvider,
)
from eth_web3.providers.websocket import (
    WebsocketProvider,
)
from eth_web3.testing import (
    Testing,
)
...
from eth_web3.version import (
    Version,
)

if TYPE_CHECKING:
    from eth_web3.pm import PM  # noqa: F401
    from eth_web3._utils.empty import Empty  # noqa: F401
...
class Web3:
    ...
    @property
    def api(self) -> str:
        from eth_web3 import __version__
    ...
    def keccak(
        ...
        if isinstance(primitive, (bytes, int, type(None))):
            ...
            return utils_eth_keccak(input_bytes)
    ...
    def enable_unstable_package_management_api(self) -> None:
        from eth_web3.pm import PM  # noqa: F811
