...
from eth_web3._utils.compat import (
    Literal,
)
from eth_web3.middleware.buffered_gas_estimate import (
    async_buffered_gas_estimate_middleware,
)
from eth_web3.providers import (
    BaseProvider,
)
from eth_web3.providers.async_base import (
    AsyncBaseProvider,
)
...
class AsyncEthereumTesterProvider(AsyncBaseProvider):
    ...
    def __init__(self) -> None:
        ...
        from eth_web3.providers.eth_tester.defaults import API_ENDPOINTS
