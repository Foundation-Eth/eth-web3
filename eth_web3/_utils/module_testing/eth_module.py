...
from eth_web3._utils.module_testing.module_testing_utils import (
    assert_contains_log,
    async_mock_offchain_lookup_request_response,
    mine_pending_block,
    mock_offchain_lookup_request_response,
)
from eth_web3._utils.type_conversion import (
    to_hex_if_bytes,
)
...
if TYPE_CHECKING:
    ...
    from eth_web3.contract import Contract  # noqa: F401
