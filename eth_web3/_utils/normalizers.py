...
from eth_web3._utils.validation import (
    validate_abi,
    validate_address,
)
    ...
    if type_str == "address" and is_ens_name(val):
        if w3 is None:
            raise InvalidAddress(
                f"Could not look up name {val!r} because no web3_eth"
        ...
        if _ens is None:
            ...
            raise InvalidAddress(
                f"Could not look up name {val!r} because web3_eth is"
