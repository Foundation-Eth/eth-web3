...
class Version(Module):
    ...
    def api(self) -> NoReturn:
        raise DeprecationWarning(
            "This method has been deprecated ... Please use eth_web3.api instead."
        )

    @property
    def node(self) -> NoReturn:
        raise DeprecationWarning(
            "This method has been deprecated ... Please use eth_web3.clientVersion instead."
        )
    ...
    def ethereum(self) -> NoReturn:
        raise DeprecationWarning(
            ...
            "Please use eth_web3.eth.protocol_version instead."
        )
