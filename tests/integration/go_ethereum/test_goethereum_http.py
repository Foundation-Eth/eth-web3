...
from eth_web3._utils.module_testing.go_ethereum_admin_module import (
    GoEthereumAsyncAdminModuleTest,
)
from eth_web3._utils.module_testing.go_ethereum_personal_module import (
...
def _geth_command_arguments(rpc_port, base_geth_command_arguments, geth_version):
    ...
    if geth_version.major == 1:
        yield from (
            ...
            rpc_port,
            "--http.api",
            "admin,eth,net,eth_web3,personal,miner,txpool",
            "--ipcdisable",
