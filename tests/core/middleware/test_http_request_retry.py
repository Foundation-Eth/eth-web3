...
import eth_web3
from eth_web3.middleware.exception_retry_request import (
...
@patch("eth_web3.providers.rpc.make_post_request", side_effect=ConnectionError)
